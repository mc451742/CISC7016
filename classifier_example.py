...
Code is sourced from: https://pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html
This image classifier is based on CIFAR10 dataset and PyTorch framework
