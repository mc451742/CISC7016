...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(128 * 4 * 4, 256) # 128 * 4 (2 * 2) * 4 (2 * 2) = 2048
        self.fc2 = nn.Linear(256, 128)
        self.fc3 = nn.Linear(128, 10) # 10 labels
...
def main_cnn():
    ...
    return cnn_training_loss_list, cnn_testing_loss_list
